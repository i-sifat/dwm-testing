...
static const char *xcolorpick[] = { "/home/sifat/.local/bin/xcolor-pick", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_r	 , spawn,          {.v = roficmd } },
	{ MODKEY|ShiftMask,	        XK_Return, spawn,          {.v = dashboardcmd } },
	{ MODKEY,                   	XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_b,      spawn, 	   {.v = browsercmd } },
  	{ MODKEY,                       XK_x,      spawn,          {.v = xcolorpick } },
  	{ MODKEY,                       XK_e,      spawn,          SHCMD ("thunar")},
  	{ MODKEY,                       XK_p,      spawn,          SHCMD ("flameshot full -p $HOME/Pictures/")},
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD ("flameshot gui -p  $HOME/Pictures/")},
